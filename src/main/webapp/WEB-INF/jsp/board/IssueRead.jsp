      ...
      <div class="static clearfix">
        <div class="lnb">
          ...
          <ul class="lnb-menu">
            <li><a href="${path}/board/noticeList.do">공지사항</a></li>
            <li><a href="${path}/board/consumerList.do">사용자 커뮤니티</a></li>
            <li class="active"><a href="${path}/board/issueList.do">뉴스/보도자료</a></li>
          </ul>
        </div>
        <!-- //lnb -->
        <div class="contents">
          <div class="sub-title">
            <h3>뉴스/보도자료</h3>
            <div class="path"><span class="loc">HOME</span><span class="loc">소비자 경험 커뮤니티</span><em class="loc">뉴스/보도자료</em></div>
          </div>
          <!-- //sub-title -->
          <table class="view-tb">
            <caption>뉴스/보도자료 상세</caption>
            <colgroup>
            ...
            <tbody>
              ...
              <tr>
                <td colspan="6" class="tb-ctrl"><span class="tb-prev">이전</span><a href="issueRead.do?brdno=<c:out value="${boardInfo.prev_brdno}"/>">이전글 클릭</a></td>
              </tr>
              <tr>
                <td colspan="6" class="tb-ctrl"><span class="tb-next">다음</span><a href="issueRead.do?brdno=<c:out value="${boardInfo.next_brdno}"/>">다음글 클릭</a></td>
              </tr>
            </tbody>
          </table>
	          	<div class="board-btm">
				  ...
				  <c:choose>
					 	<c:when test="${sessionScope.id == boardInfo.reg_id || sessionScope.id == 'admin'}">	          	
				      		...
				      		<a href="issueDelete.do?brdno=<c:out value="${boardInfo.brdno}"/>" class="btn large blue">삭제</a>
			            </c:when>
			            <c:otherwise>
							<br>
						</c:otherwise>
				  </c:choose>			            
		           	 <a href="issueList.do" class="btn large">목록</a>
	          	</div>				
        </div>
        <!-- //contents -->
      </div>
