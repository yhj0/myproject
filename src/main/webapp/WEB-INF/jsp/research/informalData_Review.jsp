    ...
    <div class="sub-section">
      <div class="static clearfix">
          ...
          <ul class="lnb-menu">
            ...
            <li class="active has-sub"><a href="${path}/board/informalData_User.do">비정형 데이터 분석</a>
              <ul class="sub">
                ...
                <li class="active"><a href="${path}/board/informalData_Review.do">리뷰 데이터 감성 분석</a></li>
              </ul>
            </li>
          </ul>
        </div>
        ...
        <div class="contents">
          <div class="sub-title">
            <h3>리뷰 데이터 감성 분석</h3>
            <div class="path"><span class="loc">HOME</span><span class="loc">데이터 분석 시각화</span><span class="loc">비정형 데이터 분석</span><em class="loc">리뷰 데이터 감성 분석</em></div>
          </div>
          <!-- //sub-title -->
