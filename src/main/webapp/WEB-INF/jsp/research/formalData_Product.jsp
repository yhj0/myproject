    ...
    <div class="sub-section">
      <div class="static clearfix">
          ...
          <ul class="lnb-menu">
            <li class="active has-sub"><a href="${path}/board/formalData_User.do">정형 데이터 분석</a>
              <ul class="sub">
                ...
                <li class="active"><a href="${path}/board/formalData_Product.do">종별 제품별 사용 통계</a></li>
              </ul>
            </li>
        ...
        <div class="contents">
          <div class="sub-title">
            <h3>종별 제품별 사용 통계</h3>
            <div class="path"><span class="loc">HOME</span><span class="loc">데이터 분석 시각화</span><span class="loc">정형 데이터 분석</span><em class="loc">종별 제품별 사용 통계</em></div>
          </div>
          <!-- //sub-title -->
