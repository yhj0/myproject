...
//탈퇴수행
function fn_quit(){
	var chkVal = $('input:checkbox[id="chk"]').is(":checked");
      ...
      <div class="static clearfix">
        <div class="lnb">
          ...
          <ul class="lnb-menu">
	        ...
	        <li class="active"><a href="${path}/board/memberQuit.do">회원탈퇴</a></li>
          </ul>
        </div>
        <!-- //lnb -->
        <div class="contents">
          <div class="sub-title">
            <h3>회원탈퇴</h3>
            <div class="path"><span class="loc">HOME</span><span class="loc">마이페이지</span><em class="loc">회원탈퇴</em></div>
          </div>
          <!-- //sub-title -->
          <div class="member-out">
            <div class="member-out-bx">
              <h4><span class="hColor3">회원탈퇴</span>를 하시면..</h4>
              <ul class="d-list">
                <li>사용하고 계신 아이디(<span class="hColor3"><c:out value="${sessionScope.id}"/></span>)로 재가입 불가능합니다.</li>
                <li>탈퇴 후 3개월 뒤에 회원가입이 가능합니다.</li>
                <li>탈퇴 후 게시판 및 댓글로 기록한 게시물은 삭제되지 않고 유지됩니다.</li>
              </ul>
            </div>
